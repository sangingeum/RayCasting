...
std::pair<bool, Vec2> GameSystem::calculateRay(const Vec2& rayFrom, const Vec2& rayTo) {
...
void GameSystem::drawRay(const sf::Vector2f& from, const sf::Vector2f& to) {
...
void GameSystem::drawTriangle(const sf::Vector2f& v1, const sf::Vector2f& v2, const sf::Vector2f& v3) {
...
std::vector<Vec2> GameSystem::calculateVertexRay(const Vec2& rayFrom, float rayLength) {
...
GameSystem::GameSystem() : m_window(sf::VideoMode(GameConfig::instance().windowWidth, GameConfig::instance().widowHeight), GameConfig::instance().windowName.c_str())
{
